...
plugins.push(
    new SWPrecacheWebpackPlugin({
        ...
        dynamicUrlToDependencies: {
            ...
            '/ayuda': ['resources/views/vistasUsuarios/paginaAyuda.blade.php'],
            '/solicitudes/misSolicitudes': ['resources/views/vistasSolicitudes/misSolicitudes.blade.php'],
            '/login': ['resources/views/vistasUsuarios/formIniciarSesion.blade.php'],
            '/resetPassword/reset': ['resources/views/resetPassword/email.blade.php'],
            '/grafico1': ['resources/views/metricas/grafico1.blade.php'],
            '/grafico2': ['resources/views/metricas/grafico2.blade.php'],
            '/grafico3': ['resources/views/metricas/grafico3.blade.php'],
            '/contacto': ['resources/views/correos/contacto.blade.php']
