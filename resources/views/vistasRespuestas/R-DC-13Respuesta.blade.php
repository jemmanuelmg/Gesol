        ...
        <div class="jumbotron">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="dia">Fecha *</label>
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="dia">Fecha *</label>
                        <div class="input-group">
                            <select name="dia1" class="custom-select mb-2 mr-sm-2 mb-sm-0">
                                <option value="01">01</option> 
                                <option value="02">02</option> 
                                <option value="04">04</option>
                                <option value="05">05</option> 
                            ...
                            <h2 class="mx-1">/</h2>
                            <select name="mes1" class="custom-select mb-2 mr-sm-2 mb-sm-0">
                                <option value="01">Enero</option> 
                                <option value="02">Febrero</option> 
                                <option value="03">Marzo</option>
                                <option value="04">Abril</option> 
                            ...
                            <h2 class="mx-1">/</h2>
                            <select name="año1" class="custom-select mb-2 mr-sm-2 mb-sm-0">
                                <option value="2017">2017</option> 
                                <option value="2018">2018</option>
                            </select> 
                        </div>              
                    ...
                    <div class="form-group">
                        <label class="control-label" for="dia">Fecha *</label>
                        <div class="input-group">
                            <select name="dia2" class="custom-select mb-2 mr-sm-2 mb-sm-0">
                                <option value="01">01</option> 
                                <option value="02">02</option> 
                                <option value="04">04</option>
                                <option value="05">05</option> 
                            ...
                            <h2 class="mx-1">/</h2>
                            <select name="mes2" class="custom-select mb-2 mr-sm-2 mb-sm-0">
                                <option value="01">Enero</option> 
                                <option value="02">Febrero</option> 
                                <option value="03">Marzo</option>
                                <option value="04">Abril</option> 
                            ...
                            <h2 class="mx-1">/</h2>
                            <select name="año2" class="custom-select mb-2 mr-sm-2 mb-sm-0">
                                <option value="2017">2017</option> 
                                <option value="2018">2018</option>
                            </select> 
                        </div>              
