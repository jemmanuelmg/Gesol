            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <textarea name="Concepto2" size="30" maxlength="95" rows="5" cols="50" required class="form-control" placeholder="Introduzca un concepto, maximo 95 caracteres"></textarea>
                        </div>              
                    </div>
