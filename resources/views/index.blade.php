      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item" style="background-image: url('../images/slider-gesol-2.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Entrega tus papeles desde tu casa!</h3>
...
&nbsp;&nbsp;&nbsp;&nbsp;No mas filas!:</strong> Con Gesol puedes diligenciar cualquier solicitud académica (cambio de jornada, revision de notas, tranferencia interna, etc.) <strong>desde la comodida de tu casa!,</strong> Todo se enviará automáticamente a tu bandeja de entrada ;).
              </li>
              <li><i class="fa fa-leaf fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;
100% ecológico: Gracias a Gesol logramos reducir el uso de tinta y papel a 0.</li>
              <li><i class="fa fa-cloud-download fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;
Todo estará alojado en la nube: tus solicitudes y respuestas se guardarán aquí, para que las veas cuando quieras.</li>
              <li><i class="fa fa-id-card fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;
Tus datos personales están a salvo gracias a mecanismos de potección virtual de alta tecnología.</li>
              <li><i class="fa fa-comments-o fa-2x" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;
Servicios de ayuda, manuales, recuperación de contraseña y muchas cosas mas a tu disposición: ¡Que esperas!</li>
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4">
          <a class="btn btn-primary btn-lg" href="/usuarios/create">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Registrarse&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-thumbs-o-up fa-2x" aria-hidden="true"></i></a>
        </div>
      </div>
