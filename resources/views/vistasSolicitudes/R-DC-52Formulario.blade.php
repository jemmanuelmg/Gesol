        ...
        <div class="jumbotron">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h1><center><strong>INSCRIPCIÓN CURSO DE VACACIONES</strong></center></h1>
                    ...
                    <div class="form-group">
                      <label class="control-label" for="email">Correo Electronico *</label>
                        <div class="input-group">
                            <input type="text" name="email" size="30" class="form-control" placeholder="Introduzca su correo electronico" required> 
                        </div>              
                    </div>
                    ...
                    <div class="form-group">
                      <label class="control-label" for="horas">Horas de clase semanalesI *</label>
                        <div class="input-group">
